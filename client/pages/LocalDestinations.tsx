      ...
      <div className="container max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-700">
            Discover authentic national parks, hiking trails, and outdoor attractions across the United States
          </p>
        </div>

        <div className="mb-8">
          <div className="bg-[#2d8a9a] text-gray-800 rounded-2xl p-6 md:p-8 shadow-lg">
            <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="local-tabs flex w-full border-b border-gray-200">
                  <TabsTrigger value="zipcode" className="data-[state=active]:text-[#2d8a9a] text-gray-700">By Zip Code</TabsTrigger>
                  <TabsTrigger value="state" className="data-[state=active]:text-[#2d8a9a] text-gray-700">By State</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="zipcode" className="mt-4 space-y-4">
                  ...
                  <div>
                    <Label htmlFor="zipcode-category">Filter by Category (optional)</Label>
                    <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                      <SelectTrigger id="zipcode-category" className="mt-1">
                        <SelectValue placeholder="All categories" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="all">All categories</SelectItem>
                        <SelectItem value="National Park">National Parks</SelectItem>
                        <SelectItem value="National Monument">National Monuments</SelectItem>
                        <SelectItem value="National Forest">National Forests</SelectItem>
                        <SelectItem value="State Park">State Parks</SelectItem>
                        <SelectItem value="hiking">Hiking Trails</SelectItem>
                ...
                <TabsContent value="state" className="mt-4 space-y-4">
                  ...
                  <div>
                    <Label htmlFor="state-category">Filter by Category (optional)</Label>
                    <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                      <SelectTrigger id="state-category" className="mt-1">
                        <SelectValue placeholder="All categories" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="all">All categories</SelectItem>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {destinations.map((destination) => (
              <Card key={`destination-${destination.id}`} className="overflow-hidden flex flex-col h-full">
        ...
        {addToListId && (
          <div className="mt-12 flex justify-center">
            <Button variant="outline" asChild>
              <Link href={`/lists/${addToListId}`} className="inline-flex items-center gap-2">
        ...
        <DialogContent>
          ...
          <div className="py-4">
            {selectedDestination && (
              <div className="flex gap-4 items-center">
                ...
                />
                <div>
                  <h4 className="font-semibold text-sm">{selectedDestination.name}</h4>
                  <p className="text-xs text-muted-foreground">{selectedDestination.city}, {selectedDestination.state}</p>
                </div>
              </div>
            )}
          </div>
          ...
          <DialogFooter>
            ...
            <Button className="bg-primary" onClick={() => {
              if (selectedDestination && addToListId) {
                handleAddToList(selectedDestination.id);
              }
            }}>
              <Link href={`/lists/${addToListId}`}>
                Go to List
              </Link>
            </Button>
          </DialogFooter>
