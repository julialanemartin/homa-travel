...
const additionalCostData = [
  ...
  {
    destinationId: 11,  // Maldives
    currency: "MVR",
    budgetAccommodation: 1500,
    midrangeAccommodation: 4000,
    luxuryAccommodation: 10000,
    budgetMeal: 200,
    midrangeMeal: 500,
    fineDiningMeal: 1200,
    publicTransport: 100,
  ...
  {
    destinationId: 12,  // Bangkok
    currency: "THB",
    budgetAccommodation: 800,
    midrangeAccommodation: 2000,
    luxuryAccommodation: 6000,
    budgetMeal: 150,
    midrangeMeal: 400,
    fineDiningMeal: 1500,
    publicTransport: 100,
  ...
  {
    destinationId: 13,  // Venice
    currency: "EUR",
    budgetAccommodation: 80,
    midrangeAccommodation: 180,
    luxuryAccommodation: 400,
    budgetMeal: 20,
    midrangeMeal: 40,
    fineDiningMeal: 100,
    publicTransport: 15,
  ...
  {
    destinationId: 14,  // Rio de Janeiro
    currency: "BRL",
    budgetAccommodation: 150,
    midrangeAccommodation: 400,
    luxuryAccommodation: 1000,
    budgetMeal: 30,
    midrangeMeal: 80,
    fineDiningMeal: 200,
    publicTransport: 15,
  ...
  {
    destinationId: 15,  // Serengeti
    currency: "TZS",
    budgetAccommodation: 100000,
    midrangeAccommodation: 300000,
    luxuryAccommodation: 800000,
    budgetMeal: 20000,
    midrangeMeal: 50000,
    fineDiningMeal: 150000,
    publicTransport: 10000,
    taxiRide: 50000,
    carRental: 150000,
    attractionTicket: 100000,
    localTour: 500000,
    seasonalMultipliers: {
      summer: 1.2,
      winter: 0.8,
